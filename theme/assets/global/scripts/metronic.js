...
var Metronic = function() {
    ...
    var handlePortletTools = function() {
        ...
        $('body').on('click', '.portlet > .portlet-title > .tools > .collapse, .portlet .portlet-title', function(e) {
            e.preventDefault();
            var el = $(this).closest(".portlet").children(".portlet-body");
            if ($('a',this).hasClass("collapse")) {
                $('a',this).removeClass("collapse").addClass("expand");
                el.slideUp(200);
            } else {
                $('a',this).removeClass("expand").addClass("collapse");
                el.slideDown(200);
            }
        });
    };
