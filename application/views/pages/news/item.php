        ...
        <div class="sides">
            <div class="content-text">
                <div class="content-important content__title-photo">
                    <img class="d-block" src="<?=newthumbs($page->image_head, 'news', 1192, 415, '1192x415x1', 1)?>" alt="">
                    <img class="d-none" src="<?=newthumbs($page->image_list, 'news', 335, 245, '335x245x1', 1)?>" alt="">
                </div>
                            ...
                            <div class="content-bottom">
                                <?php foreach ($lastNews as $lastNew) {?>
                                    <div class="bottom-item">
                                        <a href="/<?=$lclang?>/<?=$menu['all'][6]->uri?>/<?=$lastNew->uri?>/">
                                            <img src="<?=newthumbs($lastNew->image_list, 'news', 335, 245, '335x245x1', 1)?>" alt="">
                                        </a>
                                        <div class="title-h4">
                                            <a href="/<?=$lclang?>/<?=$menu['all'][6]->uri?>/<?=$lastNew->uri?>/">
                                                <?=$lastNew->title?>
                                        ...
                                        <p class="text-span">
                                            <?=date('d.m.Y', strtotime($lastNew->add_date))?>
                                        </p>
                                    </div>
                                <?php }?>
                            </div>
