...
$head1='Категории каталога';
$head2='Редактирование категории';
$head3='NameRU';
$addnew='категорию';
$tblname='catalog_category';
$headerloc='catalog_category';
...
$form[]=admin_form_textarea(true,'Text','Описание');
$form[]=admin_form_file(false,'Image','Фото блока',$tblname);
...
if ($_SERVER['REQUEST_METHOD']=='POST') {
	$err=save_data($_POST['data'],$checker,$files,$tblname,$form);
}
