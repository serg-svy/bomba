...
$form=array();
$form[]=admin_form_text(true,'title','Название');
$form[]=admin_form_textarea(true,'desc','Описание');

$form1=convert_form($form);

$files=array();
$checker=array('title_ru', 'title_ro');
		...
		foreach($checkb as $barr)
		{
			echo "<tr>";
				echo "<td width=\"40\" celpadding=\"5\" cellspacing=\"10\" oid=\"".$barr['id']."\" align=\"center\" class=\"sorthold\">";
					echo $barr['sorder'];
				echo "</td>";
				echo "<td><a href=\"$e_path".$barr['id']."/\">".$barr['title_ru']."</a>";
				echo "</td>";
