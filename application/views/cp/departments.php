...
$head1='Департаменты';
$head2='Редактирование департамента';
$head3='header_ru';
$addnew='депатамент';
$tblname='departments';
$headerloc='departments';
...
$form[]=admin_form_textarea(false,'phones','Телефоны');
$form[]=admin_form_textarea(true,'worktime','Часы работы');
$form[]=admin_form_textarea(true,'short_worktime','Коротко Часы работы');
$form[]=admin_form_text(false,'email','E-mail');

$form1=convert_form($form);

$files=array();
$checker=array('header_ru', 'header_ro');
		...
		foreach($checkb as $barr)
		{
			echo "<tr>";
				echo "<td width=\"40\" celpadding=\"5\" cellspacing=\"10\" oid=\"".$barr['id']."\" align=\"center\" class=\"sorthold\">";
					echo $barr['sorder'];
				echo "</td>";
				echo "<td><a href=\"$e_path".$barr['id']."/\">".$barr['header_ru']."</a>";
				echo "</td>";
