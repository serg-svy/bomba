...
$head1='Доставка';
$head2='Редактирование доставки';
$head3='name_ru';
$addnew='тип доставки';
$tblname='delivery_type';
$headerloc='delivery_type';
...
$form[]=admin_form_textarea(true,'description','Описание');
$form[]=admin_form_file(false,'image','Изображение (40px x 40px)',$tblname);
$form[]=admin_form_file(false,'image_active','Изображение при выборе (40px x 40px)',$tblname);

$form1=convert_form($form);

$files=array('image','image_active');
