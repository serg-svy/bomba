...
$head1='баннеры на главной';
$head2='Редактирование баннера';
$head3='text1_ru';
$addnew='баннер';
$tblname='main_banners';
$headerloc='main_banners';
...
$form=array();
$form[]=admin_form_text(true,'text1','Заголовок');
$form[]=admin_form_text(true,'link','Ссылка');
$form[]=admin_form_file(true,'image','Изображение  1408x184px',$tblname);
$form[]=admin_form_file(true, 'image_mobile', 'Мобильное изображение364x440px', $tblname);

$form1=convert_form($form);

$files=array('image_ru', 'image_ro', 'image_mobile_ru', 'image_mobile_ro');
$checker=array();
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control" name="data[position]">
                                    ...
                                    <option value="3">третий баннер</option>
                                </select>
                            </td>
                        </tr>
						<tr>
		...
		foreach($checkb as $barr)
		{
			echo "<tr>";
				echo "<td width=\"40\" celpadding=\"5\" cellspacing=\"10\" oid=\"".$barr['id']."\" align=\"center\" class=\"sorthold\">";
					echo $barr['sorder'];
				echo "</td>";
				echo "<td><a href=\"$e_path".$barr['id']."/\">".$barr['text1_ru']."</a>";
				echo "</td>";
		...
		<div class="">
			<table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="data[position]">
                            <option <?=('1'==$data['position']) ? 'selected' : '' ?> value="1">Первый баннер</option>
                            <option <?=('2'==$data['position']) ? 'selected' : '' ?> value="2">Второй баннер</option>
                            <option <?=('3'==$data['position']) ? 'selected' : '' ?> value="2">третий баннер</option>
                        </select>
                    </td>
                </tr>
				<tr>
...
<style>
    tr div {
        ...
        box-shadow: 3px 3px 5px #cccccc94;
        text-align: center;
        margin: 5px;
    }
</style>
