...
$addnew = 'заказ';
$tblname = 'quick_orders';
$headerloc = 'quick_orders';
$cond = "";
            ...
            <?php foreach ($checkb as $barr): ?>
                <tr id="order_<?=$barr['id']?>">
                    ...
                    <td style="display: flex">
                        <button data-id="<?=$barr['id']?>" type="button" class="btn btn-primary btn-sm" id="manualSendToUna">отпр. заказ в программу</button>
