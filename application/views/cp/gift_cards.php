...
$head1='Подарочные карты';
$head2='Редактирование карты';
$head3='name_ru';
$addnew='карт';
$tblname='gift_cards';
$headerloc='gift_cards';
...
$form[]=admin_form_textarea(true,'text','Описание', 'ckeditor');
$form[]=admin_form_file(true,'image','Фото (224px x 140px)',$tblname);
