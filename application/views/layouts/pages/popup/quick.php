<div class="popup__quick popup">
    <div class="popup__inner">
        ...
        <form name="quick" class="review-form" action="/<?=$lclang?>/product/quick/" method="post" enctype="multipart/form-data">
            <input type="hidden" value="<?=$product->id?>" name="quick[product_id]">
