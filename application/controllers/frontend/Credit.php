...
class Credit extends FrontEndController
{
    private $page_id;
    ...
    public function index() {
        ...
        $this->load->model('credit_companies_model');
        $credit_companies = $this->credit_companies_model->get_credit_companies($this->lclang);

        $this->data['inner_view'] = 'pages/credit/index';
        $this->data['page'] = $page;
        $this->data['credit_companies'] = $credit_companies;
