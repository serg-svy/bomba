...
class Pickup extends FrontEndController
{
    private $page_id;
    ...
    public function index() {
        ...
        $cities = $this->cities_model->get_cities_for_pickup($this->lclang);

        $this->load->model("pickup_blocks_model");
        $pickup_blocks = $this->pickup_blocks_model->get_blocks($this->lclang);

        $this->data['inner_view'] = 'pages/pickup/index';
        $this->data['page'] = $page;
        $this->data['stores'] = $stores;
        $this->data['cities'] = $cities;
        $this->data['pickup_blocks'] = $pickup_blocks;
