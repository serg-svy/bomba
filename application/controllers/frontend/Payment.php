...
class Payment extends FrontEndController
{
    ...
    public function index() {
        ...
        $this->load->model("payment_blocks_model");
        $payment_blocks = $this->payment_blocks_model->get_blocks($this->lclang);

        $this->data['inner_view'] = 'pages/payment/index';
        $this->data['page'] = $page;
        $this->data['payment_blocks'] = $payment_blocks;
