...
<style type="text/css">
	...
	.ci-profiler-box { padding: 10px; margin: 0 0 10px 0; max-height: 800px; overflow: auto; color: #fff; font-family: Monaco, 'Lucida Console', 'Courier New', monospace; font-size: 11px !important; }
